...
namespace {
    struct worker {
        ...
        typedef std::deque< fostlib::workerpool< void >::function_type > queue_type;
...
fostlib::workerpool< void >::~workerpool() {
}


bool ::worker::exec( workers_type::value_type self ) const {
    fostlib::workerpool< void >::function_type f;
...
void fostlib::workerpool< void >::operator () ( function_type f ) {
...
void fostlib::workerpool< void >::operator () () {
