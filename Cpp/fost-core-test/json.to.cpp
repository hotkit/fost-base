...
FSL_TEST_FUNCTION( atoms ) {
    ...
    FSL_CHECK_EQ( fostlib::json::unparse( fostlib::json( L"Hello" ), false ), L"\"Hello\"" );
    FSL_CHECK_EQ( fostlib::json::unparse( fostlib::json( L"Bob's" ), false ), L"\"Bob's\"" );
    FSL_CHECK_EQ( fostlib::json::unparse( fostlib::json( L"Bob says \"Hello\"" ), false ), L"\"Bob says \\\"Hello\\\"\"" );
}
