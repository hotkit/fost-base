...
namespace fostlib {
    ...
    /// Encoding and checking of the base32 strings. We will ignore the nil at the end
    //. of the alphabet
    ...
    struct base32_string_tag {
        ...
        static void do_encode(const fostlib::ascii_string &l, fostlib::ascii_string &s) {
            s = l;
            check_encoded(s);
        }
    ...
    template<const char A[34]>
    struct coercer<tagged_string<base32_string_tag<A>, ascii_string>, array_view<const unsigned char>> {
        tagged_string<base32_string_tag<A>, ascii_string> coerce(array_view<const unsigned char> m) {
            std::string into;
    ...
    struct coercer<tagged_string<base32_string_tag<A>, ascii_string>, std::array<f5::byte, N>> {
        tagged_string<base32_string_tag<A>, ascii_string> coerce(std::array<f5::byte, N> m) {
            return fostlib::coerce<tagged_string<base32_string_tag<A>, ascii_string>>(
