...
namespace fostlib::rsa {
    ...
    /// Create RSA private key by base64url_encoded of modulus, public exponent and private exponent
    CryptoPP::RSA::PrivateKey private_key(base64url_encoded n, base64url_encoded e, base64url_encoded d);
    /// Create RSA public key by base64url_encoded of modulus and public exponent
    CryptoPP::RSA::PublicKey public_key(base64url_encoded n, base64url_encoded e);
    ...
    namespace PKCS1v15_SHA256 {
        ...
        base64url_encoded sign(base64url_encoded message, CryptoPP::RSA::PrivateKey private_key);
