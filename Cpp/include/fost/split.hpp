...
namespace fostlib {
    ...
    template<typename C, typename R, std::size_t PL = 1u,
        typename L = std::function<bool(typename C::const_iterator::value_type)>>
    ...
    public:
        ...
        public:
            ...
            results_type operator * () const {
                return results_type(pos, next);
            }
        ...
        const_iterator begin() const {
            return const_iterator(predicate, container.begin(), container.end());
        }
