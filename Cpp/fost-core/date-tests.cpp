...
FSL_TEST_FUNCTION( constructors ) {
    ...
    FSL_CHECK_EXCEPTION( fostlib::date( 2009, 02, 29 ), boost::gregorian::bad_day_of_month& );
}
...
FSL_TEST_FUNCTION( json ) {
    ...
    FSL_CHECK_EXCEPTION(fostlib::coerce< fostlib::date >( fostlib::json::parse( L"{}" ) ), fostlib::exceptions::not_implemented&);
}
