...
fostlib::wliteral const fostlib::exceptions::cast_fault::message() const noexcept {
...
fostlib::exceptions::external_process_failure::external_process_failure( const string &command ) noexcept
: exception( command ) {
}
const wchar_t * const fostlib::exceptions::external_process_failure::message() const noexcept {
...
fostlib::exceptions::json_error::json_error( const string &message, const json &value ) noexcept
: exception( message ) {
    try {
...
fostlib::wliteral const fostlib::exceptions::json_error::message() const noexcept {
    return L"JSON error";
}


#include <fost/exception/missing_setting.hpp>
fostlib::exceptions::missing_setting::missing_setting( const string &section, const string &name ) noexcept
: exception() {
    try {
...
const wchar_t * const fostlib::exceptions::missing_setting::message() const noexcept {
...
fostlib::exceptions::not_a_number::not_a_number( const string &message, const string &value ) noexcept
: exception( message ) {
    try {
        insert(data(), "value", value);
    } catch ( ... ) {
...
const wchar_t * const fostlib::exceptions::not_a_number::message() const noexcept {
...
fostlib::exceptions::not_implemented::not_implemented( const string &func, const string &mes, const string &extra ) noexcept
: exception(mes) {
    try {
        insert(data(), "function", func);
...
const wchar_t * const fostlib::exceptions::not_implemented::message() const noexcept {
...
fostlib::exceptions::not_null::not_null( const string &mes, const string &inf ) noexcept
: exception(mes) {
    try {
...
fostlib::exceptions::not_unique::not_unique( const string &error, const string &context, const string &alternative1, const string &alternative2 ) noexcept
: exception( error ) {
    try {
...
fostlib::exceptions::null::null( const string &mes ) noexcept
: exception( mes ) {
}
...
fostlib::exceptions::out_of_range_string::out_of_range_string( const string &mn, const string &mx, const string &v ) noexcept {
    try {
        insert(data(), "value", v);
        insert(data(), "min", mn);
        insert(data(), "max", mx);
...
fostlib::exceptions::out_of_range_string::out_of_range_string( const string &mes, const string &mn, const string &mx, const string &v ) noexcept
: exception( mes ) {
    try {
        insert(data(), "value", v);
        insert(data(), "min", mn);
...
const wchar_t * const fostlib::exceptions::out_of_range_string::message() const noexcept {
    return L"Value outside of allowable range";
}


#include <fost/exception/overflow.hpp>
fostlib::exceptions::overflow< fostlib::string >::overflow( const string &message ) noexcept
: exception( message ) {
}
fostlib::exceptions::overflow< fostlib::string >::overflow( const string &message, const string &n, const string &d, const string &m ) noexcept
: exception( message ) {
    try {
...
fostlib::exceptions::overflow< fostlib::string >::overflow( const string &n, const string &d, const string &m ) noexcept
: exception() {
    try {
        insert(data(), "numerator", n);
        insert(data(), "denominator", d);
...
const wchar_t * const fostlib::exceptions::overflow< fostlib::string >::message() const noexcept {
...
fostlib::exceptions::parse_error::parse_error( const string &message, const string &value ) noexcept
: exception( message ) {
    try {
        insert(data(), "value", value);
    } catch ( ... ) {
...
fostlib::exceptions::settings_fault::settings_fault( const string &error, const string &domain, const string &section, const string &name, const string &value ) noexcept
: exception( error ) {
...
const wchar_t * const fostlib::exceptions::settings_fault::message() const noexcept {
    return L"Internal Setting library fault";
}


#include <fost/exception/unexpected_eof.hpp>
fostlib::exceptions::unexpected_eof::unexpected_eof() noexcept
: exception() {
}
fostlib::exceptions::unexpected_eof::unexpected_eof(const string &msg) noexcept
: exception(msg) {
}
fostlib::exceptions::unexpected_eof::unexpected_eof(const string &msg, const string &f) noexcept
: exception(msg) {
    try {
...
const wchar_t * const fostlib::exceptions::unexpected_eof::message() const noexcept {
    return L"Unexpected EOF";
}


#include <fost/exception/unexpected_nil.hpp>
fostlib::exceptions::unexpected_nil::unexpected_nil() noexcept
: exception() {
}
fostlib::exceptions::unexpected_nil::unexpected_nil( const string &e ) noexcept
: exception( e ) {
}
const wchar_t * const fostlib::exceptions::unexpected_nil::message() const noexcept {
...
const wchar_t * const fostlib::exceptions::unicode_encoding::message() const noexcept {
